<template>
  <div class="main-section container">
    ...
    <div class="example" v-if="legislator.party === '民主進步黨'">
      ...
      <div contenteditable>
        <p>
          你好，請問是 <strong>{{legislator.name}}</strong> 委員的辦公室嗎？我是 <strong>{{selectedDistrict}}</strong> 的選民，我對民進黨強勢通過 <strong>砍七天假</strong> 版本的勞基法草案感到非常不滿。吳秉叡委員開記者會時說「如果反對民進黨版本勞基法草案，以後選舉可以不投民進黨」，請告訴 <strong>{{legislator.name}}</strong> 委員，如果委員不公開反對 <strong>砍七天假</strong> 的勞基法修法版本並在院會把法案撤銷或重付審查，我以後：
        </p>
        <p>
